    ...
    const projects = [
        {
            ...
            description: 'Developed a real-time chat application using the MERN stack and Socket.io. Implemented smooth messaging experience with RESTful APIs and MongoDB for user and message data storage.',
            tech: ['MongoDB', 'Express.js', 'React', 'Node.js', 'Socket.io'],
            gradient: 'from-primary via-purple-500 to-secondary',
            features: ['Real-time messaging via Socket.io', 'User authentication', 'RESTful API backend', 'MongoDB data storage'],
        ...
        },
        {
            ...
            description: 'A full-stack online auction platform enabling users to list products, place bids, and manage auctions. Built a responsive frontend using React and Vite, integrated seamlessly with backend REST APIs.',
            tech: ['React.js', 'Node.js', 'Express.js', 'MongoDB', 'REST API'],
            gradient: 'from-accent via-pink-500 to-primary',
            features: ['Dynamic item listing', 'Bid placement system', 'User authentication', 'Responsive React + Vite UI'],
        ...
        },
        {
            ...
            description: 'An e-commerce platform focused on environmentally sustainable products. Features product catalog, interactive UI, efficient cart system, and emission factor tracking for eco-friendly shopping.',
            tech: ['React.js', 'Node.js', 'Express.js', 'MongoDB'],
            gradient: 'from-secondary via-teal-500 to-emerald-500',
            features: ['Product catalog with images', 'Emission factor tracking', 'Order management system', 'Interactive cart system'],
