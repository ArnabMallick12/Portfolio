    ...
    const socialLinks = [
        {
            ...
            ), url: 'https://www.linkedin.com/in/arnab-mallick-86769a237/', color: 'hover:bg-[#0077b5]'
        },
        {
            name: 'GitHub', icon: (
            ...
            ), url: 'https://github.com/ArnabMallick12', color: 'hover:bg-[#333]'
        },
        {
            name: 'LeetCode', icon: (
            ...
            ), url: 'https://leetcode.com/u/mallick126', color: 'hover:bg-[#ffa116]'
        },
    ];
