...
const Contact = () => {
    ...
    const contactInfo = [
        { icon: '✉️', label: 'Email', value: 'arnavmallick12006@gmail.com', href: 'mailto:arnavmallick12006@gmail.com', gradient: 'from-primary to-purple-400' },
        ...
        { icon: '🌐', label: 'Portfolio', value: 'arnab-mallick.vercel.app', href: 'https://arnab-mallick.vercel.app/', gradient: 'from-emerald-500 to-teal-400' },
    ];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    <div className="reveal-left" style={{ transitionDelay: '0.1s' }}>
                        ...
                        <p className="text-text-secondary leading-relaxed mb-8">
                            ...
                            collaborative ideas, or full-stack and mobile development work. Feel free to reach out!
                        </p>
