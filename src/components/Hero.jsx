...
const Hero = () => {
    ...
    // For Google Drive: change the sharing setting to "Anyone with link"
    const profileImage = "https://drive.google.com/file/d/1TNqOnaw2QOOFwfJi4GBTEGGbaMQnQH3E/view?usp=drive_link";

    // 📄 PASTE YOUR RESUME GOOGLE DRIVE LINK HERE!
    const resumeLink = "https://drive.google.com/file/d/1Y9g4xkJ8xuqRX1P6r5aSkVAc9_WWXfZP/view?usp=sharing";

    const [displayText, setDisplayText] = useState('');
    const [currentIndex, setCurrentIndex] = useState(0);
    const titles = ['Full-Stack Developer', 'MERN Stack Expert', 'Problem Solver', 'Tech Enthusiast'];

    // Auto-format Google Drive links to work inside <img> tags automatically!
    ...
    if (profileImage.includes('drive.google.com/file/d/')) {
        ...
        if (idMatch && idMatch[1]) {
            // Newest trick to bypass Google Drive's third-party cookie/CORS blocks!
    ...
    const socialLinks = [
        {
            ...
            ), url: 'https://www.linkedin.com/in/arnab-mallick-86769a237/', color: 'hover:bg-[#0077b5] hover:shadow-[0_0_30px_rgba(0,119,181,0.4)]'
        },
        {
            name: 'GitHub', icon: (
            ...
            ), url: 'https://github.com/ArnabMallick12', color: 'hover:bg-[#333] hover:shadow-[0_0_30px_rgba(51,51,51,0.4)]'
        },
        {
            name: 'LeetCode', icon: (
            ...
            ), url: 'https://leetcode.com/u/mallick126', color: 'hover:bg-[#ffa116] hover:shadow-[0_0_30px_rgba(255,161,22,0.4)]'
        },
    ];
            ...
            <div className="max-w-7xl mx-auto px-5 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="lg:order-1 order-2 text-center lg:text-left">
                    ...
                    <p className="text-text-secondary text-lg max-w-lg mx-auto lg:mx-0 mb-8 leading-relaxed animate-slide-up" style={{ animationDelay: '0.4s' }}>
                        B.Tech CSE Student at IIIT Vadodara passionate about building
                    ...
                    <div className="relative w-64 h-64 md:w-[350px] md:h-[350px]">
                            ...
                            <div className="w-full h-full rounded-full bg-bg-dark flex items-center justify-center overflow-hidden relative">
                                {profileImage !== "YOUR_IMAGE_LINK_HERE" && profileImage !== "" ? (
                                    <img
                                        ...
                                        onError={(e) => {
                                            // Provide ultimate fallback if Drive link is private or fails
                        ...
                        <div className="absolute inset-0 pointer-events-none">
                            ...
                            {[
                                ...
                                { icon: 'https://cdn.simpleicons.org/nodedotjs/339933', label: 'Node', pos: 'top-[30%] -right-4 md:-right-12', delay: '1s' },
                                ...
                                { icon: 'https://cdn.simpleicons.org/cplusplus/00599C', label: 'C++', pos: 'top-[45%] -left-4 md:-left-16', delay: '2s' },
                            ].map((item, i) => (
                                <div
                                    key={item.label}
